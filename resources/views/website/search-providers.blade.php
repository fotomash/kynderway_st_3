            ...
            <div class="main-section-data">
                ...
                <div class="row">
                    <div class="col-lg-12 mb-3 pad-left-mob pad-right-mob" style="font-weight: bold;">
                        <h3 class="pb-2 title-h3" style="font-weight:bold; font-size: 26px; color: #304384;">Select Category</h3>
                        <hr class="bold" />
                    </div>
                </div>
                ...
                <div class="row jobtypediv">
                    <div class="col-lg-12 mb-3 mt-4 pad-left-mob pad-right-mob" style="font-weight: bold;">
                        <h3 class="pb-2 title-h3" style="font-weight:bold; font-size: 26px; color: #304384;">Job Type</h3>
                        <hr class="bold" />
                    </div>
                                    ...
                                    <form>
                                        ...
                                        <select class="form-control" name="searchCountry" id="searchCountry" style="-webkit-appearance: menulist-button; margin-bottom: 5px; display: none;">
                                            ...
                                            @foreach($countries AS $key => $value)
                                                 {{-- <option value="{{$value->name}}" {{('United Kingdom' == $value->name)? 'selected' : ''}}>{{$value->name}}</option> --}}
                    ...
                    <div class="col-lg-9 pad-right-mob">
                        <div class="row mt-1 mb-3">
                            <div class="col-lg-12 pl-0 pr-0">
                                <h3 class="pb-2 title-h3" style="font-weight:bold; font-size: 26px; color: #304384;">Search Results</h3>
                                <hr class="bold" />
                            </div>
                        </div>
...
<!-- End Model -->
<div class="modal fade" id="modalSuccessPostJob" tabindex="-1" role="dialog" aria-labelledby="modalSuccessPostJobLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title text-white" id="modalSuccessPostJobLabel">Your invite was sent!</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <p id="modal-message" class="alert alert-success alert-dismissible mt-3">
        ...
        <div class="modal-footer">
          <button type="button" id="jobapplybtnok" data-url="nanny" data-dismiss="modal" class="btn btn-lg btn-block btn-kinderway" style="background-image: linear-gradient(to right, #8c50a0 , #304384); border-radius: 50px; cursor: pointer;">ok !</button>
        </div>
      </div>
    </div>
  </div>
