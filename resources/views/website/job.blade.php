                        ...
                        <div class="form-group">
                            <div class="mt-3">
                                <label class="form-label modal_margin">
                                    <span class="mintxt-modal" id="modal_job_val">Register or Login to View Job.</span>
                                </label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p id="modal-message" class="alert alert-success alert-dismissible mt-3">The job poster will contact you if they think you are suitable for this position. Messages regarding this job application will appear on your dashboard
              </p>
            </div>
            <div class="modal-footer">
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if($('.post-bar').length >0 && !$('.post-bar').first().hasClass('--empty')){
                $('.post-bar').first().trigger('click');
            }

            function showJob(currpopup){
