...
@section('content')
    ...
    <section class="profile-account-setting" data-is-new="{{ Auth::user()->is_new }}">
        <div class="container">
                                ...
                                <div class="acc-setting">
                                    {{-- <div class="cp-field">
                                        ...
                                        <div class="form-row four-cols mt-4">
                                            @include('shared.categories', ['arrows' => false, 'active' => 'Maternity', 'tag' => 'a', 'class1' => '', 'class2' => '', 'class3' => 'btn-kinderway-cat'])
                                        </div>
                                    </div> --}}
                                    ...
                                    <form action="{{ url('/provider/service-profiles/addallprofiles') }}" method="POST"
                                          id="frmnurse" class="">
                                        @csrf
                                        <input type="hidden" name="hid_profileval" value="2">
                                        <div class="cp-field">
                                            <h5>Job Duration</h5>
