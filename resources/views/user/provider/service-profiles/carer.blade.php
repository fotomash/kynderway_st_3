                            ...
                            <div class="tab-pane fade show active" id="nav-password" role="tabpanel"
                                ...
                                <div class="acc-setting">
                                    ...
                                    {{-- <div class="cp-field">
                                        ...
                                        <div class="form-row four-cols mt-4">
                                            @include('shared.categories', ['arrows' => false, 'active' => 'Carer', 'tag' => 'a', 'class1' => '', 'class2' => '', 'class3' => 'btn-kinderway-cat'])
                                        </div>
                                    </div> --}}
                                    ...
                                    <form action="{{ url('/provider/service-profiles/addallprofiles') }}" method="POST"
                                          id="frmcarer" class="">
                                        @csrf
                                        <input type="hidden" name="hid_profileval" value="3">
                                        <div class="cp-field">
                                            <h5>Job Duration</h5>
                                        ...
                                        <div class="cp-field form-row">
                                            <div class="col-lg-4 col-xs-12 pb-4">
                                                {{-- <div class="cp-field" style="width: 25%;"> --}}
                                                <h5>Currency</h5>
                                                <div class="cpp-fiel error-ele">
                                            ...
                                            <div class="col-lg-4 col-xs-12 pb-4">
                                                {{-- <div class="cp-field" style="width: 50%;"> --}}
                                                <h5>Pay Frequency</h5>
                                                <div class="cpp-fiel error-ele">
                                ...
                                '0') ?  'checked' : ''}}>
                                        ...
                                        <div class="cp-field">
                                            ...
                                            <div class="cpp-fiel error-ele">
                                            <textarea row="5" name="edu_details" placeholder="Tell us more about yourself and your skills" id="edu_details" style="white-space: pre-wrap;">{{ isset( $currprofile['curr_profile']['edu_description']) ?  $currprofile['curr_profile']['edu_description'] : '' }}</textarea>
