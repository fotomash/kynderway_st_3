                                ...
                                <div class="acc-setting">
                                    {{-- <div class="cp-field">
                                        ...
                                        <div class="form-row four-cols mt-4">
                                            @include('shared.categories', ['arrows' => false, 'active' => 'Housekeeper', 'tag' => 'a', 'class1' => '', 'class2' => '', 'class3' => 'btn-kinderway-cat'])
                                        </div>
                                    </div> --}}

                                    <form action="{{ url('/provider/service-profiles/addallprofiles') }}" method="POST"
                                          id="frmhousekeeper" class="">
                                        @csrf
                                        <input type="hidden" name="hid_profileval" value="6">
                                        <div class="cp-field">
                                            <h5>Job Duration</h5>
                                                ...
                                                <ul class="job-tags">
                                                    @foreach($jtypes AS $key => $value)
                                                        <li class="limargin">
                                                            ...
                                                            " name="options_jobtype[]"
                                                                   id="checkbox{{$loop->iteration}}_jtype"
                                                                   autocomplete="off"
                                                                   value="{{$value->id}}"
                                                            @if(isset($currprofile
                                                            ['job_type']) && (
                                                            ...
                                                            @endif ">
                                                                <label class=""
                                                                       for="checkbox{{$loop->iteration}}_jtype">
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            if ($("#frmhousekeeper").length) {
                $("#frmhousekeeper").validate({
