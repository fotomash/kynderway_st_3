                                                                   ...
                                                                   <div class="row">
                                                                       <div class="col-md-9 p-0">
                                                                           <div class="provider-picy" >
                                                                               <img src="{{ Helper::getProfilePic($allUserJob['job_userid']) }}" style="border-radius: 14px;" alt="">
                                                                           </div>
                                                                           <h3 class="mb-0"
                                                                               ...
                                                                               <span class="float-right-desktop" style="font-size: 14px; font-style: italic; color: #304384; font-weight: bold; padding-top: 4px;" id="chatMessage-{{ $allUserJob['conid'] }}">
                                                                                ...
                                                                                @if ($allUserJob['fullconnect'])
                                                                                    ...
                                                                                    @if (Helper::getTotalCount($allUserJob['conid'],$allUserJob['job_userid']) == 0 && $allUserJob['requested_by'] == 'service_provider')
                                                                                        @if (Helper::getUnseenCount($allUserJob['conid'], $allUserJob['provider_id']) > 0)
                                                                                        ...
                                                                                        @endif
                                                                                    @elseif (Helper::getTotalCount($allUserJob['conid'],$allUserJob['job_userid']) == 0 && $allUserJob['requested_by'] != 'service_provider')
                                                                                        Chat with {{ $allUserJob['name'] }} now
                                                                                    @elseif (Helper::getUnseenCount($allUserJob['conid'], $allUserJob['provider_id']) > 0)
                                                                                           ...
                                                                                           <li><a id="chatbtn" type="button" class="message_now" style="color: #fff; padding: 0px;" data-toggle="modal"
                                                                                               ...
                                                                                               >
                                                                                                   ...
                                                                                                   <i class="fas fa-comment" style="background-color: transparent; width: 50px;">
                                                                                                       <span id="chatCount-{{ $allUserJob['conid'] }}">{{ Helper::getUnseenCount($allUserJob['conid'],$allUserJob['provider_id']) }}</span>
                                                                                                   </i>
                                                                                               </a>
                                                                                           </li>
                                                                                       @else
...
{{--    <script src="{{ mix('js/app.js') }}"></script>--}}
   <script>
      ...
      var hasProfile = @json(Helper::hasProfile());
       if(!hasProfile) {
           $.ajax({
               url: '/user/check-new',
               type: 'GET',
