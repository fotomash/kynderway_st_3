                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="nav-password" role="tabpanel"
                                ...
                                <div class="acc-setting">
                                    ...
                                    <form action="{{ url('/provider/change_password') }}" method="POST"
                                        ...
                                        <div class="cp-field">
                                            ...
                                            <div class="cpp-fiel">
                                                <input type="password" class="form-control" name="confirm_password" id="confirm_password"
                                                       placeholder="Enter New Password">
                                                {{-- <i class="fa fa-lock"></i> --}}
                                                <i class="la la-eye inputicon_cls" id="hide-password-2" onclick="togglePasswordView1()"></i>
                                                <i class="la la-eye-slash inputicon_cls" id="show-password-2" style="display: none;" onclick="togglePasswordView1()"></i>
                                            </div>
                                        </div>
