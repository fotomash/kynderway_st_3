                            ...
                            <tbody>
                                @forelse($users as $user)
                                    <tr>
                                        ...
                                        <td>@if($user->type == 'service_provider'){{ ($user->marketing == 1) ? 'Yes' : 'No' }} @endif</td>
                                        <td>{{ ($user->email_verified_at == NULL) ? 'No' : 'Yes' }}</td>
                                        <td>@if($user->country){{ $user->country }} @endif</td>
                                        ...
                                        <td>
                                                            ...
                                                            <div class="block block-themed block-transparent mb-0">
                                                                ...
                                                                <div class="block-content font-size-sm" id="mediumBody">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="mb-2">
                                                                                <img src="{{ Helper::getProfileImage($user->profile_picture) }}" alt="Profile Picture" width="100" height="100">
                                                                            </div>
                                                                            {{-- <div class="mb-2">
                                            ...
                                            @if($user->email_verified_at != NULL)
                                                @if($user->is_block)
                                                    <a href="javascript:void(0);" onclick="changeBlockStatus( '{{ $user->id }}', '0');" data-toggle="modal" data-target="#statusModal">
                                                        <i class="fa fa-check text-success fa-fw" data-toggle="tooltip" data-placement="bottom" title="Activate Account"></i>
                                                    </a>
                                                @else
                                                    <a href="javascript:void(0);" onclick="changeBlockStatus( '{{ $user->id }}', '1');" data-toggle="modal" data-target="#statusModal">
                                                        <i class="fa fa-times text-warning fa-fw" data-toggle="tooltip" data-placement="bottom" title="Suspend Account"></i>
                                                    </a>
                                                @endif
                                                <a href="javascript:void(0);" onclick="deleteUser('{{ $user->id }}');" data-toggle="modal" data-target="#deleteModal">
