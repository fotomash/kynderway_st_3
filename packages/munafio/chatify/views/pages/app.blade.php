...
<div class="messenger">
    ...
    <div class="messenger-listView" style="display: none; !important;">
        ...
        <div class="m-header" style="display: none;">
            ...
            <div class="messenger-listView-tabs">
                ...
                <a href="#" @if($route == 'group') class="active-tab" @endif data-view="groups"  style="display: none">
                    <span class="fas fa-users"></span> Groups</a>
            </div>
        </div>
        {{-- tabs and lists --}}
        <div class="m-body" style="display: none;">
           {{-- Lists [Users/Group] --}}
           {{-- ---------------- [ User Tab ] ---------------- --}}
           <div class="@if($route == 'user') show @endif messenger-tab app-scroll" data-view="users">

               {{-- Favorites --}}
               <p class="messenger-title"  style="display: none">Favorites</p>
           ...
           {{-- ---------------- [ Group Tab ] ---------------- --}}
           <div class="@if($route == 'group') show @endif messenger-tab app-scroll" data-view="groups"  style="display: none">
                {{-- items --}}
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging" style="display: none">
            <nav>
